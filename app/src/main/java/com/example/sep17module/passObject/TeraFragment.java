...
import com.example.sep17module.databinding.FragmentTeraBinding;
...
public class TeraFragment extends Fragment {
    ...
    private FragmentTeraBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentTeraBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Employee e = bundle.getParcelable("data");

        binding.tvGetObject.setText(e.toString());
