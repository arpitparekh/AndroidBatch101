...
import com.example.sep17module.databinding.FragmentLBinding;
...
public class LFragment extends Fragment {
    ...
    private FragmentLBinding binding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Deliver d=bundle.getParcelable("data");

        binding.tvBundle.setText(d.toString());
    }
}