...
import com.example.sep17module.databinding.FragmentKBinding;
...
public class KFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Deliver d =new Deliver("Honda",50000);
...
//            Fragment fragment=new LFragment();
            getActivity().getSupportFragmentManager().beginTransaction()
                    .replace(R.id.activityHolder,LFragment.class,bundle)
                    .addToBackStack("KFragment")
                    .commit();
